  ...
  export default {
    ...
    methods: {
      ...
      joinRoom(url) {
        ...
        callFrame.join({ url, token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJvIjpmYWxzZSwiciI6Ikh2cjJ4TEx5Q244eTNCcm9RY29YIiwiZXhwIjoxNzI0Nzk0MTA1LCJ1IjoiTGluYSBLcm91c2UiLCJ1ZCI6MSwic3MiOmZhbHNlLCJ2byI6dHJ1ZSwiYW8iOnRydWUsInAiOnsiY3MiOmZhbHNlfSwiZCI6ImRiNjViYzUzLTQ3NzAtNGM3YS05NDE4LTUzYmQ1NzA4YTNkMiIsImlhdCI6MTcyNDc5MjMwNX0.UzUWa4ptzM7usiGJwwcQEjkExXASm7sEQZVbEFFUulQ' ,showFullscreenButton: true });
      },
      submitJoinRoom(e) {
        e.preventDefault();
