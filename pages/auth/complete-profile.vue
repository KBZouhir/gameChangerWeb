...
const isSectorOnDomain = (sector) => {
    return selectedDomains.value.some(selectedDomain => selectedDomain.business_sector_id === sector.id);
}
        ...
        <div class="col-span-5 md:col-span-3 relative" :class="activeStep != 2 ? 'h-screen' : ''">
            <div class="mx-auto h-full flex flex-col max-w-7xl px-2 sm:px-6 lg:px-8 py-8">
                ...
                <div v-if="activeStep == 0" class="flex-1 overflow-hidden">
                    ...
                    <div class="flex flex-wrap gap-4 py-8 h-full overflow-auto">
                ...
                <div v-if="activeStep == 1" class="flex-1 flex flex-col overflow-hidden">
                    ...
                    <p class="text-[#989394]">
                        Select a few of your working domain to match with users who have similar things in common.
                    </p>
            ...
            <USlideover v-model="isOpen">
                <div class="p-4 flex-1 overflow-y-auto">
                    ...
                    <div class="flex flex-col p-2" v-if="!showDomains">
                        ...
                        <p class="text-[#989394]">
                            Select a few of your business sector to match with users who have similar things in common.
                        </p>
                        ...
                        <div class="flex-1 overscroll-y-auto">
                            <div v-for="businessSector in businessSectors" @click="getdomain(businessSector)"
                                :class="isSectorOnDomain(businessSector) ? 'bg-green-100 hover:bg-green-200 border-green-300' : ''"
                                ...
                                <div class="text-[#0F1454]">
                                    <h3 class="font-bold text-xl">{{ businessSector.translated_name }}</h3>
                    ...
                    <div class="flex flex-col p-2" v-if="showDomains">
                        <h1 class="font-bold text-3xl mb-4">#{{ selectedSector.translated_name }}</h1>
                        ...
                        <div class="grid grid-cols-2 gap-4 sticky bottom-0 bg-white py-4">
                            <UButton block color="primary" size="lg"
                                @click="{ selectedSector = null; showDomains = false }" variant="outline">Back</UButton>
