  ...
  <div class="relative flex flex-col min-h-screen bg-[#f1f5f9] dark:bg-[#0f172a]">
    ...
    <div
      ...
      <div
        ...
        <div class="overflow-y-auto pt-6 ps-3 h-full flex flex-col">
          <div class="flex-1">
            <nav id="side">
              <ul role="list" class="space-y-1 my-4">
                <li @click="isOpen = false">
                  <nuxt-link to="/" :class="{ 'bg-[#34d399] text-white': $route.path === '/' }"
                ...
                <li @click="isOpen = false">
                  <nuxt-link to="/notifications"
                    :class="{ 'bg-[#34d399] text-white': $route.path === '/notifications' }"
                    class="group flex items-center gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 dark:text-white text-gray-600 hover:bg-gray-800 hover:text-white">
                ...
                <li @click="isOpen = false">
                  <nuxt-link to="/conferences" :class="{ 'bg-[#34d399] text-white': $route.path === '/conferences' }"
                    class="group flex items-center gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 dark:text-white text-gray-600 hover:bg-gray-800 hover:text-white">
            ...
            <nav id="side"
              class="flex-1 font-medium text-sm text-black border-t pt-3 mt-2 dark:text-white dark:border-slate-800">
                ...
                <li class="uk-parent">
                  <a href="#" class="group">
                    ...
                    <ion-icon name="chevron-down"
                      class="text-base ml-auto duration-200 group-aria-expanded:rotate-180 md hydrated" role="img"
